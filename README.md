...
使用 GitHub Actions 每天定时启动三次 RSSHub，抓取 X 账号 `weixin_wechat`、`openai`、`github`、`claudeai`、`elonmusk`、`thsottiaux` 和 BBC 中文（`bbcchinese`），然后把静态 RSS 发布到 GitHub Pages。
...
https://mystool.me/x-rss-feed/feeds/thsottiaux.xml
